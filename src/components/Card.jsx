   ...
   return(
      ...
      <li key={key} className={(lastValue > 0) ? "border-l-green-600 " + clases : "border-l-red-500 " + clases }>
         ...
         <div className="flex py-2">
            <p className="grow"><span className="font-regular">Precio:</span> {parseFloat(precioDolar).toFixed(2)} USD</p>
            <p className="grow"><span className="font-regular">Valor actual:</span> <span className={(lastValue > 0) ? "positive" : "negative"}>{ parseFloat(lastValue).toFixed(1) } %</span></p>
         </div>
